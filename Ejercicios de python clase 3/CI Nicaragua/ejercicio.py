import os
import CI.importar_mod as importar_mod #import functions to importar_mod
...
while True:
    ...
    if option == 1:
        ...
        print("\n\t\tThe sum of ", num1, "+", num2, "=", importar_mod.suma(num1,num2))
    elif option == 2:
        num1, num2 = enter_numbers()
        print("\n\t\tThe subtraction of ", num1, "-", num2, "=", importar_mod.resta(num1,num2))
    elif option == 3:
        num1, num2 = enter_numbers()
        print("\n\t\tThe product of ", num1, "*", num2, "=", importar_mod.mult(num1,num2))
    elif option == 4:
        num1, num2 = enter_numbers()
        if num2 != 0:
            print("\n\t\tThe quotient of ", num1, "/", num2, "=", importar_mod.div(num1,num2))
        else:
